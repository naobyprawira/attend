    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 lg:space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/10">
          ...
          <div className="mt-4">
            <span className="text-3xl font-black tracking-tighter text-on-surface">14</span>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/10">
          ...
          <div className="mt-4 flex items-end">
            <span className="text-3xl font-black tracking-tighter text-on-surface">98.2%</span>
            <div className="ml-4 flex-1 h-1.5 bg-surface-container-high rounded-full overflow-hidden mb-2">
        ...
        {/* Overtime Hours */}
        <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/10 sm:col-span-2 lg:col-span-1">
          <div className="flex justify-between items-start">
            <span className="text-[10px] font-bold text-secondary tracking-widest uppercase">Overtime Hours</span>
            <span className="material-symbols-outlined text-primary">history</span>
          </div>
          <div className="mt-4">
            <span className="text-3xl font-black tracking-tighter text-on-surface">124.5h</span>
      ...
      {/* Shift Table */}
      <div className="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-[0_20px_50px_-12px_rgba(27,28,29,0.08)]">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[700px]">
            <thead>
              <tr className="bg-surface-container-low">
                <th className="px-4 sm:px-8 py-5 text-[10px] font-bold text-on-surface-variant tracking-[0.15em] uppercase">Shift Name</th>
                <th className="px-4 sm:px-8 py-5 text-[10px] font-bold text-on-surface-variant tracking-[0.15em] uppercase">Type</th>
                <th className="px-4 sm:px-8 py-5 text-[10px] font-bold text-on-surface-variant tracking-[0.15em] uppercase text-center">Check-In</th>
                <th className="px-4 sm:px-8 py-5 text-[10px] font-bold text-on-surface-variant tracking-[0.15em] uppercase text-center">Check-Out</th>
                <th className="px-4 sm:px-8 py-5 text-[10px] font-bold text-on-surface-variant tracking-[0.15em] uppercase text-center">Grace</th>
                <th className="px-4 sm:px-8 py-5 text-[10px] font-bold text-on-surface-variant tracking-[0.15em] uppercase text-center">Threshold</th>
                <th className="px-4 sm:px-8 py-5 text-[10px] font-bold text-on-surface-variant tracking-[0.15em] uppercase text-right">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-outline-variant/10">
              {SHIFTS.map((shift) => (
                <>
                  ...
                  >
                    <td className="px-4 sm:px-8 py-6 font-bold text-on-secondary-fixed">
                    ...
                    <td className="px-4 sm:px-8 py-6 text-center text-on-surface-variant font-medium">{shift.checkIn}</td>
                    <td className="px-4 sm:px-8 py-6 text-center text-on-surface-variant font-medium">{shift.checkOut}</td>
                    <td className="px-4 sm:px-8 py-6 text-center text-on-surface-variant">{shift.grace}</td>
                  ...
                  {/* Timeline Sub-row */}
                  {expandedId === shift.id && (
                    <tr key={`${shift.id}-timeline`} className="bg-surface-container/30">
                      <td className="px-4 sm:px-8 pb-8" colSpan={7}>
                        <div className="bg-surface-container-lowest p-4 sm:p-8 rounded-xl border border-outline-variant/20">
                          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
                            ...
                            <div className="flex space-x-6">
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="text-[10px] font-bold text-on-surface-variant">CORE SHIFT</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <div className="w-3 h-3 rounded-full bg-primary-container" />
                                <span className="text-[10px] font-bold text-on-surface-variant">GRACE PERIOD</span>
                              </div>
                            </div>
                          </div>

                          {/* Timeline Bar */}
                          <div className="relative w-full h-16 bg-surface-container-high rounded-lg overflow-hidden flex items-center">
                            {/* Time Markers */}
                            ...
                            {/* Timeline Content */}
                            <div className="relative h-10 mx-auto w-4/5 bg-surface-container-high/50 rounded-md overflow-hidden flex items-center">
        ...
        {/* Pagination */}
        <div className="px-4 sm:px-8 py-6 bg-surface-container-low/50 flex flex-col sm:flex-row justify-between items-center gap-4">
      ...
      <div className="p-4 sm:p-8 rounded-2xl bg-surface-container-highest text-on-surface flex flex-col sm:flex-row items-center justify-between gap-6">
