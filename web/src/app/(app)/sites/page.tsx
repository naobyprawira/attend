  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8 bg-surface dark:bg-dark-surface min-h-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {SITE_STATS.map((stat) => (
          <div key={stat.label} className="bg-surface-variant dark:bg-dark-surface-variant p-6 rounded-xl border border-outline-variant/10 relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-black text-on-surface dark:text-dark-on-surface">{stat.value}</h3>
        ...
        {/* Uptime Donut */}
        <div className="bg-surface-variant dark:bg-dark-surface-variant p-6 rounded-xl border border-outline-variant/10 relative overflow-hidden group flex flex-col items-center justify-center">
          <p className="text-[10px] font-bold tracking-[0.2em] text-on-surface-variant dark:text-dark-on-surface-variant uppercase mb-3 self-start">
            Uptime
          </p>
          <div className="relative w-24 h-24 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-xl font-black text-on-surface dark:text-dark-on-surface">99.8%</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-5 border-b border-outline-variant/10 dark:border-dark-outline-variant/10 flex flex-wrap justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant dark:text-dark-on-surface-variant text-sm">search</span>
              <input
                type="text"
                placeholder="Search sites..."
                className="bg-surface-container-highest dark:bg-dark-surface-container-highest border-none rounded-lg text-sm pl-9 pr-4 py-2 focus:ring-2 focus:ring-primary/20 text-on-surface dark:text-dark-on-surface w-48"
              />
            </div>
            ...
            <tbody>
              {SITES.map((site) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 font-mono text-on-surface dark:text-dark-on-surface">{site.cameras}</td>
                  <td className="px-5 py-4 font-mono text-on-surface dark:text-dark-on-surface">{site.personnel}</td>
                  ...
                  <td className="px-5 py-4 text-xs text-on-surface-variant dark:text-dark-on-surface-variant">{site.lastSync}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* Distribution Map */}
      <div className="bg-surface-variant dark:bg-dark-surface-variant rounded-xl border border-outline-variant/5 overflow-hidden p-4 sm:p-6 lg:p-8">
        <h4 className="text-sm font-bold tracking-widest uppercase text-on-surface-variant dark:text-dark-on-surface-variant mb-6">
          Distribution Map
        </h4>
        <div className="relative w-full aspect-[2.2/1] bg-surface-container-high dark:bg-dark-surface-container-high rounded-xl overflow-hidden">
          {/* Simplified world map outline */}
          <svg className="w-full h-full" viewBox="0 0 1000 450" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Continents simplified */}
            <path d="M150,120 Q200,100 250,110 Q280,90 320,100 L340,130 Q330,160 300,170 Q270,200 240,190 L200,210 Q170,190 150,160 Z" className="fill-on-surface-variant/10 dark:fill-dark-on-surface-variant/10" />
            <path d="M350,140 Q380,120 420,110 Q460,100 500,110 Q530,120 550,140 L560,180 Q540,220 500,230 Q460,240 420,230 L380,200 Q360,170 350,140 Z" className="fill-on-surface-variant/10 dark:fill-dark-on-surface-variant/10" />
            <path d="M620,130 Q680,100 750,110 Q800,120 840,140 L860,180 Q850,220 820,250 Q780,270 740,260 L680,240 Q640,210 620,170 Z" className="fill-on-surface-variant/10 dark:fill-dark-on-surface-variant/10" />
            <path d="M220,250 Q260,240 290,260 L310,300 Q300,340 270,350 Q240,340 220,310 Z" className="fill-on-surface-variant/10 dark:fill-dark-on-surface-variant/10" />
            <path d="M720,300 Q760,290 800,300 L820,340 Q800,370 770,370 Q740,360 720,330 Z" className="fill-on-surface-variant/10 dark:fill-dark-on-surface-variant/10" />
          </svg>
          ...
          {REGIONS.map((region) => (
            ...
            >
              ...
              <span className="text-[9px] font-bold text-on-surface-variant dark:text-dark-on-surface-variant mt-1.5 whitespace-nowrap bg-surface-variant/80 dark:bg-dark-surface-variant/80 px-2 py-0.5 rounded">
                {region.name}
              </span>
            </div>
          ))}
